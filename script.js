document.addEventListener('DOMContentLoaded', () => {
    ...
    const policies = {
        privacy: `
            ...
            <p>At Bidarn (accessible from bidarn.fun), one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Bidarn and how we use it.</p>
            ...
            <ul>
                <li>Provide, operate, and maintain our website and Bidarn subscription services.</li>
            ...
            <p>Like any other website, Bidarn uses 'cookies'. These cookies are used to store information including visitors' preferences, and the pages on the website that the visitor accessed or visited. The information is used to optimize the users' experience by customizing our web page content based on visitors' browser type and/or other information.</p>
        `,
        refund: `
            <h2>Refund Policy</h2>
            <p><strong>Effective Date: July 8, 2026</strong></p>
            <p>We want to ensure that you are 100% happy with your purchase from Bidarn. If you have any technical or sales queries, do not hesitate to contact us. However, if you feel the service you purchased is not the best fit for your requirements and you have attempted to resolve issues with our support staff, we want to make things right.</p>
            ...
            <p>To request a refund, please open a chat with us on WhatsApp or send an email. Provide your order details and the username of your Bidarn subscription line. We will process eligible refunds within 3-5 business days.</p>
        `,
        terms: `
            <h2>Terms of Service</h2>
            <p><strong>Effective Date: July 8, 2026</strong></p>
            <p>Welcome to Bidarn! These Terms of Service outline the rules and regulations for the use of Bidarn's Website, located at bidarn.fun.</p>
            
            <h3>1. Acceptable Use Policy</h3>
            <p>By purchasing our Bidarn subscription, you agree that you are purchasing access to digital resources for personal use only. Sharing your M3U link, Xtream credentials, or account details with other individuals is strictly prohibited.</p>
            ...
            <p>You must have a compatible hardware device and a stable broadband internet connection to stream content. Bidarn is not responsible for buffering or latency caused by ISP throttling, low bandwidth, or local network congestion.</p>
        `
    };
