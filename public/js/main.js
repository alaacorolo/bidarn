/* ==========================================================================
   BIDARN IPTV - Interactivity & UI Polish (main.js)
   ========================================================================== */
...
/**
 * Handles the toggling of pricing periods (1 Mois, 3 Mois, 6 Mois, 1 An)
 */
function setupPricingToggle() {
  ...
  toggleButtons.forEach(button => {
    button.addEventListener('click', () => {
      ...
      const targetPeriod = button.getAttribute('data-period'); // 'monthly', 'quarterly', 'halfyearly', 'yearly'
